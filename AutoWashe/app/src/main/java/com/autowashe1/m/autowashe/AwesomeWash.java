...
public class AwesomeWash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_awesome_wash);
        cart=findViewById(R.id.cart4suv);
        ...
        cart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent=new Intent(AwesomeWash.this,trail.class);
