...
public class SpecialWashTruck extends AppCompatActivity {
    Button cart;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_special_wash_truck);
        cart=findViewById(R.id.cart2truck);
        ...
        cart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent=new Intent(SpecialWashTruck.this,trail.class);
